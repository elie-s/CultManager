...
{
    [CustomPropertyDrawer(typeof(IntGauge))]
    public class IntGaugeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            float progression = maxProperty.intValue > 0 ? (float)currentProperty.intValue / (float)maxProperty.intValue : 0;
